...
class ProductTemplate(models.Model):
    ...
    def _get_product_accounts(self):
        ...
        return {
            ...
            'income_x': self.property_account_income_x_id or self.categ_id.property_account_income_categ_x_id,
            'expense_x': self.property_account_expense_x_id or self.categ_id.property_account_expense_categ_x_id,
        }
